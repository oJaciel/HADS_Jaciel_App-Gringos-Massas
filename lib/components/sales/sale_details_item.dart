...
class SaleDetailsItem extends StatefulWidget {
  const SaleDetailsItem(this.sale, {super.key});

  final Sale sale;

  @override
  State<SaleDetailsItem> createState() => _SaleItemState();
}

class _SaleItemState extends State<SaleDetailsItem> {
            ...
            subtitle: Column(
              ...
              children: [
                ...
                if (widget.sale.clientName != null &&
                  ...
                  Text(
                    'Cliente: ${widget.sale.clientName!}',
                    style: TextStyle(color: Colors.grey[700]),
                  ),
              ],
            ),
